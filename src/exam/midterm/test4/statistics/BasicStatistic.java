...
public class BasicStatistic implements Statistic {
    ...
    public double max() {
        ...
        for (int i = 0; i < size(); i++) {
            maxValue = Math.max(maxValue, (double) dataSet.getAt(i));
        }
        return maxValue;
    }
    ...
    public double min() {
        ...
        for (int i = 0; i < size(); i++) {
            minValue = Math.min(minValue, (double) dataSet.getAt(i));
        }
        return minValue;
    }
    ...
    public double mean() {
        ...
        for (int i = 0; i < dataSet.size(); i++) {
            double value = (double) dataSet.getAt(i);
            sum += value;
        }
    ...
    public double[] rank() {
        ...
        for (int i = 0; i < length; i++) {
            pairs[i] = new Pair(i, dataSet.getAt(i));
        }
