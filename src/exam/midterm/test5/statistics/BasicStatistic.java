...
public class BasicStatistic implements Statistic {
    ...
    public double max() {
        ...
        for (int i = 0; i < size(); i++) {
            maxValue = Math.max(maxValue, (double) dataSet.elementAt(i));
        }
        return maxValue;
    }
    ...
    public double min() {
        ...
        for (int i = 0; i < size(); i++) {
            minValue = Math.min(minValue, (double) dataSet.elementAt(i));
        }
        return minValue;
    }
    ...
    public double mean() {
        ...
        for (int i = 0; i < dataSet.size(); i++) {
            double value = (double) dataSet.elementAt(i);
            sum += value;
        }
    ...
    public double[] rank() {
        ...
        for (int i = 0; i < length; i++) {
            pairs[i] = new Pair(i, dataSet.elementAt(i));
        }
    ...
    public double median() {
        ...
        for (int i = 0; i < size(); i++) {
            sorted.add(dataSet.elementAt(i));
        }
