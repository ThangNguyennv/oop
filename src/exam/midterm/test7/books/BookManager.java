...
public class BookManager {
    ...
    public MyList sortByTitle(boolean order) {
        ...
        for (int i = 0; i < n; i++) {
            array[i] = (Book) books.get(i);
        }

        // Sắp xếp mảng theo tiêu chí của compareTo() trong Book
        Arrays.sort(array);
        ...
        // Tạo một danh sách mới và thêm sách đã được sắp xếp.
    ...
    public MyList sortByPageNumber(boolean order) {
        ...
        Arrays.sort(array, new PageComparison());
