...
public class NumberTheory {
    ...
    public static void testPerfectAndDeficient() {
        ...
        printPerfect(amount);
        System.out.println();
        System.out.println("[" + countPerfect(amount) +
                " perfect numbers found (" +
                String.format("%.2f", (countPerfect(amount) * 1.0 * 100) / amount) + "%)]");
        System.out.println("These numbers are neither deficient nor perfect:");
        isNotPerfectAndDeficient(amount);
        System.out.println();
        System.out.println("[" + countNotDeficientAndPerfect(amount) +
                " numbers found (" +
    ...
    public static void testPrime() {
        ...
        int amount = sc.nextInt();
        primeList(amount);
        System.out.println("[" + countPrime(amount) +
    ...
    public static void testPrimeFactor() {
        ...
        System.out.println();
        System.out.println("[" + countPrimeFactor(amount) +
